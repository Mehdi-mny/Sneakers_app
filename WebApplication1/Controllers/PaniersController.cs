...
namespace WebApplication1.Controllers
{
    public class PaniersController : Controller
    {
        ...
        public PaniersController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Panier != null ? 
                          ...
                          Problem("Entity set 'WebApplication1Context.Panier'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Panier panier)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication1Context.Panier'  is null.");
            }
            var panier = await _context.Panier.FindAsync(id);
            if (panier != null)
            {
